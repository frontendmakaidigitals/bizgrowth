...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn(
        "bg-oklch(1 0 0) group/calendar p-3 [--cell-size:2rem] in-data-[slot=card-content]:bg-transparent in-data-[slot=popover-content]:bg-transparent dark:bg-oklch(0.147 0.004 49.25)",
      ...
      classNames={{
        ...
        dropdown_root: cn(
          "has-focus:border-oklch(0.709 0.01 56.259) border-oklch(0.923 0.003 48.717) shadow-2xs has-focus:ring-oklch(0.709 0.01 56.259)/50 has-focus:ring-[3px] relative rounded-md border dark:has-focus:border-oklch(0.553 0.013 58.071) dark:border-oklch(1 0 0 / 15%) dark:has-focus:ring-oklch(0.553 0.013 58.071)/50",
        ...
        range_end: cn("bg-oklch(0.97 0.001 106.424) rounded-r-md dark:bg-oklch(0.268 0.007 34.298)", defaultClassNames.range_end),
        today: cn(

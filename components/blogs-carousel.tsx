// components/BlogsCarousel.tsx  ← "use client" only for carousel state
"use client";
  ...
  return (
    <section className="py-1 mt-16 mb-12 lg:mb-0 lg:mt-0 lg:py-10 text-gray-900 relative">
      <div className="container">
        <h2 className="text-4xl text-center lg:text-5xl font-bold mb-6">
          Latest from the <span className="text-lime-600">Blog</span>
        </h2>

        {/* Static links rendered in HTML for Googlebot */}

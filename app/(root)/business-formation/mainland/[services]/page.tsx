        ...
        <div className="mt-10 grid grid-cols-1 gap-5">
          {processData?.fourthPoints.map((item, index) => (
            ...
            >
              ...
              <p className="font-SplineSans font-medium mt-5 text-xl">
                {item.title}
              </p>
      ...
      <div className="w-full container  my-24 py-14" id={"table"}>
        ...
        {processData?.keyPoints ? (
          <div className="w-full mt-4">
            <div>
              <p className="text-md font-SplineSans font-medium">Key Points:</p>
            </div>
        ...
        {processData?.ajmanKeypoints ? (
          <div className="w-full mt-4">
            <div>
              <p className="text-lg font-SplineSans font-medium">
            ...
            <div className="w-full mt-1">
              <ul>
                {processData.ajmanKeypoints.map((item, index) => (
                  <li
                    key={index}
                    className="font-Satoshi font-normal flex items-center gap-2"
                  >
        ...
        {processData?.fujairahKeypoints ? (
          <div className="w-full mt-4">
            <div>
              <p className="text-lg font-SplineSans font-semibold">
                Compliance and Post-Setup Services in Fujairah Mainland License
              </p>
              <p className="font-Satoshi text-md font-medium">

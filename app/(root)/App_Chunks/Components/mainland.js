...
const data = [
  {
    ...
    thirdPoints: [
      ...
      <p key={3} className="font-Satoshi text-lg">
        <span className="font-Synonym font-semibold">Tourism License :</span> A
      ...
      <p key={4} className="font-Satoshi text-lg">
        <span className="font-Synonym font-semibold"> Agricultural License :</span>{" "}
      ...
      <p key={5} className="font-Satoshi text-lg">
        <span className="font-Synonym font-semibold"> Contracting License :</span>{" "}
      ...
      <p key={7} className="font-Satoshi text-lg">
        <span className="font-Synonym font-semibold"> Instant License :</span> This
  ...
  },
  {
    ...
    thirdPoints: [
      <p key={0} className="font-Satoshi text-lg">
        <span className="font-Synonym font-semibold">Commercial License :</span> A
      ...
      <p key={5} className="font-Satoshi text-lg">
        <span className="font-Synonym font-semibold">Healthcare License :</span> A
      ...
      <p key={6} className="font-Satoshi text-lg">
        <span className="font-Synonym font-semibold">Educational License :</span>{" "}
      ...
      <p key={7} className="font-Satoshi text-lg">
        <span className="font-Synonym font-semibold"> Construction License :</span>{" "}
    ...
    fourthPoints: [
      ...
      },
      {
        ...
        isPoints: false,
        desc: "Memorandum of Association (MoA) is an outline-solid of the company’s legal structure and this document must be notarized by the Sharjah Courts.",
      },
      {
  ...
  },
  {
    ...
    thirdPoints: [
      ...
      <p key={6} className="font-Satoshi text-lg">
        <span className="font-Synonym font-semibold">Franchise License :</span> A
      ...
      <p key={8} className="font-Satoshi text-lg">
        <span className="font-Synonym font-semibold">Import/Export License :</span>{" "}
  ...
  },
  {
    ...
    thirdPoints: [
      ...
      <p key={2} className="font-Satoshi text-lg">
        <span className="font-Synonym font-semibold">Industrial License :</span> A
      ...
      <p key={9} className="font-Satoshi text-lg">
        <span className="font-Synonym font-semibold"> Media License :</span> A

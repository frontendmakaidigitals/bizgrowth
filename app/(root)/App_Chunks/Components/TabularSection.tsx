            ...
            >
              {hoverId === index ? (
                <AnimatePresence mode="wait">
                  <div>
                    <div className="mb-3 w-full font-Satoshi">
                      <h1 className="text-xl lg:text-3xl text-green-950 font-semibold">
                        {tab.title}
                      </h1>
                      <div className="mt-2 text-sm font-medium flex bg-[#dcedc8] px-2 rounded-lg w-full py-2 items-center gap-3">
                ...
                <div className="flex items-center justify-between w-full">
                  <motion.h1
                    className="text-xl lg:text-3xl font-Satoshi text-[#12250a] font-semibold"
                    initial={{ y: 50 }}
                    animate={{ y: 0 }}
                    transition={{ duration: 0.5, type: "spring" }}
                  >

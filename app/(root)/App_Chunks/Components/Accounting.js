...
const data = [
...

  {
    ...
    thirdPoints: [
      <p key={0} className="font-Satoshi text-lg">
        <span className="font-Synonym font-semibold">Regulatory Compliance</span>{" "}
      ...
      <p key={3} className="font-Satoshi text-lg">
        <span className="font-Synonym font-semibold">Tax Management</span> Auditing
    ...
    fourthPoints: [
      ...
      },
      {
        ...
        isPoints: false,
        desc: "We develop an audit plan, identify potential risks, and outline-solid the audit scope.",
      },
      {
        title: "Filing VAT Returns",
        isPoints: false,
...

  {
    ...
    corpTaxDesc: (
      <p className="text-center text-lg">
        ...
        <span className="font-semibold">June 1, 2023</span> that is set to impact
        ...
        corporate tax rate is set at <span className="font-semibold">9%</span> for
        businesses earning profits above{" "}
        <span className="font-semibold">AED 375,000</span>, with businesses below
    ...
    thirdPoints: [
      ...
      <p key={1} className="font-Satoshi text-lg">
        <span className="font-Synonym font-semibold">Corporate Tax Advisory</span>{" "}
      ...
      <p key={4} className="font-Satoshi text-lg">
        <span className="font-Synonym font-semibold">Transfer Pricing</span>{" "}
      ...
      <p key={5} className="font-Satoshi text-lg">
        <span className="font-Synonym font-semibold">Audit Support</span> We offer
  ...
  },
  {
    ...
    thirdPoints: [
      <p key={0} className="font-Satoshi text-lg">
        <span className="font-Synonym font-semibold">Cost Savings</span> By
      ...
      <p key={1} className="font-Satoshi text-lg">
        <span className="font-Synonym font-semibold">Access to Expertise</span>{" "}
      ...
      <p key={5} className="font-Satoshi text-lg">
        <span className="font-Synonym font-semibold"> Time Saving</span> With
      ...
      <p key={6} className="font-Satoshi text-lg">
        <span className="font-Synonym font-semibold"> Risk Mitigation</span>{" "}

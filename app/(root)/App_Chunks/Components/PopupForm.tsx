          ...
          <div className="grid grid-cols-1 gap-6 xl:grid-cols-2">
            <div className="flex flex-col gap-y-[10px]">
              ...
              <input
                ...
                className="rounded-[10px]  border border-slate-300/80 bg-slate-200 px-4 py-2 font-normal text-black outline-hidden transition-all placeholder:text-gray-600 focus:border-primary-500 focus:shadow-xs"
                required
              />
            </div>
              ...
              <div>
                <div className="w-full!">
                  ...
                  >
                    ...
                    <SelectContent className="bg-slate-200 w-full! z-999999 font-Synonym font-medium text-slate-950">
                      <SelectGroup>
          ...
          <div className="grid grid-cols-1 gap-6">
            <div className="flex flex-col gap-y-[10px]">
              ...
              <textarea
                ...
                required
                {...register("message")}
                className="h-24 resize-none rounded-[10px]  border border-slate-300/80 bg-slate-200 px-4 py-2 font-normal text-black outline-hidden transition-all placeholder:text-gray-600 focus:border-primary-500 focus:shadow-xs xxl:h-[180px]"

...
const data = [
  {
    ...
    thirdPoints: [
      ...
      <p key={3} className="font-Satoshi text-lg">
        <span className="font-Synonym font-semibold">Multi-Currency Accounts</span>{" "}
      ...
      <p key={6} className="font-Satoshi text-lg">
        <span className="font-Synonym font-semibold"> Enhanced Security</span>{" "}
      ...
      <p key={7} className="font-Satoshi text-lg">
        <span className="font-Synonym font-semibold"> Enhanced Security</span> An

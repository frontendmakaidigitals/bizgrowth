  ...
  return (
    <AnimatePresence mode="wait">
      <motion.div
        ...
        className="fixed inset-0 w-screen h-dvh lg:h-screen min-h-[600px] bg-slate-900/40 backdrop-blur-xl z-9999999 lg:py-8"
      >
        {/* Header */}
        <div className="flex justify-between relative items-start lg:grid lg:grid-cols-2 max-w-5xl mx-auto  h-full flex-col bg-white rounded-lg lg:gap-6 p-6">
          <div className="bg-indigo-500 hidden lg:block relative rounded-lg overflow-hidden h-full">
            ...
            <div className="relative z-10 p-7">
              ...
              <button className="bg-white text-slate-900 py-3 w-full rounded-lg font-medium hover:bg-slate-100 transition shadow-xs">
                Contact Us
              </button>
            </div>
          </div>
          <div className="w-full ">
            ...
            {/* Question Counter */}
            <div className="mt-7">
              <h1 className="font-normal rounded-lg">Question</h1>
          ...
          <div className="absolute max-w-lg bottom-0 left-0 lg:right-0 lg:bottom-3 lg:left-auto z-9999999 w-full p-4">
            <button
              ...
              className="w-full text-lg text-slate-950 font-semibold py-3 flex justify-center bg-green-400 rounded-xl disabled:bg-green-400/30 disabled:text-slate-400 disabled:cursor-not-allowed"
            >
    ...
    <div className="mt-8">
      <div>
        <motion.h1
          ...
          exit="exit"
          transition={{ duration: 0.6, ease: [0.175, 0.885, 0.32, 1.1] }}
          className="text-xl lg:max-w-xl bg-green-400/30 leading-tight font-semibold p-5 border border-green-400 rounded-xl"
        >

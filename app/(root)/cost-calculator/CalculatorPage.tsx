...
const CalculatorPage = () => {
  ...
  return (
    <div className="w-full mt-16 ">
      ...
      <div id={"calculator"} className={`container w-full`}>
        ...
        >
          <div className={"  rounded-lg "}>
            ...
            <p className={"mt-4 font-Synonym font-semibold text-slate-700"}>
      ...
      <div className=" w-full my-24 bg-linear-to-r from-lime-500 via-green-500 to-emerald-500">
...
const Card = ({ region, target }: { region: any; target: string }) => {
  ...
  return (
    <div className="w-full flex flex-col justify-between items-start bg-lime-200 border  border-slate-200 rounded-xl p-7 ">
      ...
      <div className="mt-7">
        <h1 className="text-xl lg:text-2xl font-semibold text-lime-950 font-SplineSans">
          Dubai {region.name}
        </h1>
        ...
        <div className="mt-4">
          {region.data.map((item: string, index: number) => (
            <div
              key={index}
              className="flex items-start gap-3 font-Synonym mt-2 font-medium"
            >
        ...
        <button
          ...
          className="mt-6 bg-blue-500 text-slate-50 py-2 px-4 font-Synonym font-semibold rounded-lg"
        >
          Calculate now
        </button>
      </div>

              ...
              {processData?.secondPoints.map((elem, index) => (
                ...
                >
                  <div className="">
                    ...
                    <p className="font-SplineSans mt-6 text-xl font-semibold">
                      {elem.title}
                    </p>
  ...
  return (
    <div className="w-full">
            ...
            <div className="mt-10 grid grid-cols-1 lg:grid-cols-4 gap-7">
              {regulatoryAuthorities.map((item, index) => (
                <div key={index} className="p-5 bg-lime-200 rounded-xl">
                  <h1 className="text-xl font-SplineSans text-lime-950 font-semibold">
                    {item.title}
                  </h1>
      ...
      <div className="container w-full mt-6 mb-24">
        <p className="font-SplineSans font-medium">Key points</p>
        <div className="grid grid-cols-1 gap-1 mt-1">
          {keyPoints.map((item, index) => (
            <div key={index} className="flex mt-1 items-start gap-2">
              ...
              <p className="font-Satoshi font-normal">{item}</p>
            </div>
          ))}
        </div>
      </div>
          ...
          <div className="mt-10 grid grid-cols-1 lg:grid-cols-5 gap-7">
            {services.map((item, index) => (
              <div key={index} className="w-full rounded-lg bg-lime-200 p-5">
                ...
                <div>
                  <h2 className="font-SplineSans mt-6 font-semibold text-xl">
                    {item.title}
                  </h2>
                  <p className="mt-1 font-Satoshi">{item.desc}</p>
                </div>
  ...
  const tableBody = [
    ...
    },
    {
      ...
      purpose: [
        ...
        "To outline-solid the company’s assets, liabilities, and equity",
      ],
    },
    {
      title: "Business Information",
    ...
    },
    {
      ...
      purpose: [
        "To outline-solid the ownership and business structure",
          ...
          <div className="mt-10 grid grid-cols-1 lg:grid-cols-4 gap-4">
            {tradeFinanceServices.map((item, index) => (
              <div key={index} className="w-full  rounded-lg bg-lime-200 p-6">
                ...
                <p className="mt-1 font-Satoshi font-normal">{item.desc}</p>

                <div className="mt-3">
                  {item.points.map((elem, index) => (
                    <div
                      key={index}
                      className="flex font-Satoshi font-medium items-start gap-2"
                    >
                      <div>

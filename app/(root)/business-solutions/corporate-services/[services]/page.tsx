              ...
              <div>
                ...
                <div className="mt-4">
                  {visa.docs.map((doc, index) => (
                    <div
                      key={index}
                      className="flex mt-2 font-Satoshi font-medium items-start gap-2"
                    >
                      <div>
            ...
            <div className="mt-10 grid grid-cols-1 gap-5">
              {processSteps.map((item, index) => (
                ...
                >
                  ...
                  <p className="font-SplineSans font-medium text-xl mt-5">
                    {item.step}
                  </p>
    ...
    <div className="w-full">
      ...
      <div className="container w-full mt-16">
        <div className="w-full">
          ...
          <div className="mt-5 grid grid-cols-1 font-semibold text-lime-950 gap-6  font-SplineSans lg:grid-cols-2 ">
                        ...
                        <div className="mt-3">
                          {item.offerings.map((point, id) => (
                            <div key={id} className="flex items-start gap-3">
                              ...
                              <div>
                                <h3 className="text-lg font-Synonym font-medium">
                                  {point}
                                </h3>
                              </div>
                            </div>
              ...
              {services.map((item, index) => (
                <div key={index} className="w-full rounded-lg bg-lime-100">
                  <div>
                    ...
                    <h2 className="font-SplineSans font-semibold p-6  text-xl">
                      {item.title}
                    </h2>
                  </div>
                </div>

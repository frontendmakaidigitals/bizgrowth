  ...
  return (
    <div>
        ...
        <div className="grid grid-cols-1 mt-10 lg:grid-cols-3 gap-7">
          {selfPraise.map((elem, index) => (
            <div key={index} className="w-full  rounded-lg bg-amber-100 p-5">
              ...
              <div>
                <h2 className="font-SplineSans mt-5 font-semibold text-xl">
                  {elem.title}
                </h2>
      ...
      <div className="container w-full my-24">
        ...
        <div className="grid grid-cols-1 mt-10 lg:grid-cols-3 gap-7">
          {eligibility.map((elem, index) => (
            ...
            >
              <div>
                <div className="size-6  mt-px rounded-full">
                  <img src={"/media/mainland/checked.png"} />
                </div>
              </div>
              <div>
                <h2 className="font-SplineSans  font-semibold text-xl">
                  {elem.eligible}
                </h2>
                <p className="mt-1 font-Satoshi">{elem.desc}</p>
              </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mt-10">
          {goldenServices.map((item, index) => (
            <div key={index} className="w-full rounded-lg bg-amber-100 p-5">
              <div></div>
              <div>
                <h2 className="text-xl font-SplineSans font-semibold">
                  {item.name}
                </h2>
                <p>{item.desc}</p>
              </div>
            ...
            {tableData.map((item, index) => (
              <tr key={index} className="border border-slate-950 w-full">
                <td className=" py-2 border border-gray-300 ">
                  <div className="font-medium text-lg text-[#152b0c] font-SplineSans px-5 ">
                    {item.title}
                  </div>
                </td>
                <td className=" py-2 border border-gray-300 ">
      ...
      <div className="container w-full mt-6 mb-24">
        <div>
          <h1 className="text-xl font-SplineSans font-semibold">
            Golden Visa Updates for 2024
          </h1>
        </div>
        <div>
          <h1 className="text-md font-SplineSans mt-2 font-medium">
            For Professionals
          </h1>
        ...
        <div>
          ...
          <div className="ml-3 flex items-center gap-2">
            ...
            <div>
              <p className="font-Satoshi">
                <span className="font-SplineSans font-medium">
                  10-years Visa
                </span>{" "}
          ...
          <div className="ml-3 flex items-center gap-2">
            ...
            <div>
              <p className="font-Satoshi">
                <span className="font-SplineSans font-medium">5-years Visa</span>{" "}
          ...
          <div className="ml-3 flex items-center gap-2">
            ...
            <div>
              <p className="font-Satoshi">
                <span className="font-SplineSans font-medium">2-years Visa</span>{" "}
        ...
        <div>
          <h1 className="text-md font-medium mt-4">
            {" "}
        ...
        >
          {expertise.map((elem, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className="w-full relative border border-gray-300 gap-2 flex overflow-hidden justify-center p-5 items-start bg-linear-to-br from-[#DAFFEE] to-[#E2FCFF] rounded-xl"
            >
              ...
              <div className="relative z-20">
                <p className="text-lg">
                  <span className="font-SplineSans font-semibold">
                    {elem.title}
                  </span>{" "}
                  {elem.desc}
                </p>
      ...
      <div className="bg-lime-100 py-14 my-24">
        <div className="container w-full ">
          ...
          <div className="w-full mt-9 grid grid-cols-1 lg:grid-cols-2 gap-7">
            ...
            >
              <h2 className="text-2xl text-center text-lime-800 font-SplineSans font-semibold">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-7 mt-8">
          {willBenefits.map((elem, index) => (
            <div key={index} className="p-5 rounded-md bg-lime-200">
              <h2 className="font-SplineSans text-xl font-semibold">
                {elem.title}
              </h2>
              <p className="font-Satoshi font-medium mt-2">{elem.desc}</p>
            </div>
          ))}
        </div>
      </div>
        ...
        <div className="mt-10 grid grid-cols-1 gap-5">
          {willFormationSteps.map((item, index) => (
            ...
            >
              ...
              <p className="font-SplineSans font-medium mt-3 text-xl">
                {item.step}
              </p>
          ...
          <div className="mt-8 grid grid-cols-1 lg:grid-cols-4 gap-8">
            {realEstateData.map((item, index) => (
              <div key={index} className="p-3 bg-lime-200 rounded-xl">
                ...
                <div>
                  <h2 className="font-SplineSans text-lime-900 mt-8 text-xl font-semibold">
                    {item.title}
                  </h2>
                  <p className="font-Satoshi mt-1 font-normal">{item.desc}</p>
                </div>
              </div>
            ))}
          </div>
                ...
                {item.points
                  ? item.points.map((point, index) => (
                      <div key={index} className="flex mt-2 items-start gap-2">
                        ...
                        <div>
                          <p className="font-splineSans font-medium">
                            {point.title}
                          </p>
                          <p>{point.desc}</p>
                        </div>
          ...
          <div className="grid mt-9 grid-cols-1 lg:grid-cols-4 gap-3">
            {services.map((service, index) => (
              <div key={index} className="p-4 bg-lime-200 rounded-lg">
                <h2 className="text-xl font-semibold font-SplineSans">
                  {service.title}
                </h2>
                <div className="mt-2">
                    ...
                    <div className="mt-3">
                      {service.points.map((point, index) => (
                        <div key={index} className="flex items-start gap-2">
                          ...
                          <p className="mt-1 font-Satoshi font-medium">
                            {point}
                          </p>
                        </div>
                      ))}

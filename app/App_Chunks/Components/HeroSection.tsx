...
const HeroSection = () => {
  return (
    <div className="w-full h-full flex justify-center items-center">
      <div className="h-[99vh] w-screen overflow-hidden mb-24 relative">
        ...
        <div className="bg-slate-900/30 flex justify-center  items-center w-full h-full absolute top-0 left-0 ">
          <div className=" container py-20  flex flex-col justify-center items-center gap-5">
            <h1 className="text-[#f1f8e9]   text-center text-6xl font-Satoshi font-[600]">
              From Idea to Incorporation <br /> Your Business setop partner
            </h1>

          ...
          <form className="font-Satoshi">
            <div className="grid grid-cols-1 ">
              ...
              <input
                ...
                className="bg-slate-950/10 rounded-lg focus:shadow-md focus:outline-dashed  px-4 py-2 mt-1"
              />
            </div>
            ...
            <div className="grid grid-cols-1 mt-4">
              ...
              <textarea
                ...
                className="resize-none bg-slate-950/10 rounded-lg focus:shadow-md focus:outline-dashed  h-28 px-4 py-2 mt-1"
              />
            </div>
